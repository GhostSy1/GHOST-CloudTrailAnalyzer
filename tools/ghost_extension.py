...
TOOL = "GHOST-CloudTrailAnalyzer"
VERSION = "3.0-PRO"
PROFILE = "AWS CloudTrail event and action forensics"
RULES = [('CT-IDENTITY', 'userIdentity|principalId|accessKeyId'), ('CT-CHANGE', 'Create|Update|Delete|Put|Attach|Detach'), ('CT-NETWORK', 'sourceIPAddress|userAgent|requestParameters')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-CloudTrailAnalyzer v3.0-PRO (Zero-Guessing Engine)
\"\"\"
    print(banner)
